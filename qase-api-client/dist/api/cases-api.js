...
const CasesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCase: (code_6, id_2, include_1, ...args_6) => __awaiter(this, [code_6, id_2, include_1, ...args_6], void 0, function* (code, id, include, options = {}) {
            // verify required parameter 'code' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getCases: (code_7, search_1, milestoneId_1, suiteId_1, severity_1, priority_1, type_1, behavior_1, automation_1, status_1, externalIssuesType_1, externalIssuesIds_1, include_2, limit_1, offset_1, ...args_7) => __awaiter(this, [code_7, search_1, milestoneId_1, suiteId_1, severity_1, priority_1, type_1, behavior_1, automation_1, status_1, externalIssuesType_1, externalIssuesIds_1, include_2, limit_1, offset_1, ...args_7], void 0, function* (code, search, milestoneId, suiteId, severity, priority, type, behavior, automation, status, externalIssuesType, externalIssuesIds, include, limit, offset, options = {}) {
            // verify required parameter 'code' is not null or undefined
...
const CasesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCase(code, id, include, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getCase(code, id, include, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class CasesApi extends base_1.BaseAPI {
     ...
     */
    getCase(code, id, include, options) {
        return (0, exports.CasesApiFp)(this.configuration).getCase(code, id, include, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This method allows to retrieve all test cases stored in selected project.
     * @summary Get all test cases
